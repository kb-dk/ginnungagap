...
/**
 * Workflow step for preserving all the records, to be used by the preservation workflow.
 */
public class PreserveAllStep extends AbstractPreservationStep {
    /**
     * Constructor.
     ...
     */
    public PreserveAllStep(TransformationConfiguration transConf, CumulusServer server, MetadataTransformer transformer,
    ...
    public String getName() {
        return "Preserve All Step";
    }

    @Override
    protected CumulusQuery getQuery() {
        return CumulusQuery.getPreservationAllQuery(catalogName);
    }
}
