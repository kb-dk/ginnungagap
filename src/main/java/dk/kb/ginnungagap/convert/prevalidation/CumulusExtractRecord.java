...
class CumulusExtractRecord {
    ...
    protected final static String SEGMENT_PREFIX_ARCHIVE_FILENAME = "ARCHIVE_FILENAME";
    protected final static String SEGMENT_PREFIX_CATALOG_NAME = "Catalog Name"; 
    protected final static String SEGMENT_PREFIX_CHECKSUM_ORIGINAL_MASTER = "CHECKSUM_ORIGINAL_MASTER";
    protected final static String SEGMENT_PREFIX_GUID = "GUID"; 
    protected final static String SEGMENT_PREFIX_ARCHIVE_MD5 = "ARCHIVE_MD5"; 
    protected final static String SEGMENT_PREFIX_FILE_DATA_SIZE = "File Data Size"; 
