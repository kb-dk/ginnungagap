...
<head>
    <title>Update Preservation Workflow</title>
...
<div class="jumbotron text-center">
    <h1>Cumulus Preservation Service: Update Preservation Workflow</h1>
    <h2>Ginnungagap</h2>
</div>
<div id="main" class="container">
  <div id="workflow" class="container">
    ...
    <form action="${pageContext.request.contextPath}/update/run" method="post">
