...
<div id="main" class="container">
  <div id="workflow" class="container">
    ...
    <form action="${pageContext.request.contextPath}/workflow/run" method="post">
        <button type="submit" name="name" value="preservationWorkflow" class="btn btn-success" <c:if test="${disable_workflow eq true}">disabled</c:if> >Run Preservation Workflow</button>
    </form>
  </div>
</div>
</body>
