<xsl:transform version="1.0"
	...
	xmlns:tracks="http://id.kb.dk/tracks.html" extension-element-prefixes="java">
	...
	<xsl:template name="tracks">
		<xsl:if test="field[@name='Tracks']">
			<tracks:tracks
				xsi:schemaLocation="http://id.kb.dk/tracks.html http://id.kb.dk/standards/tracks/version_beta/tracks.xsd">
