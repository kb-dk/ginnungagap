              ...
              <xsl:element name="mix:ImageData">
                ...
                <xsl:if test="field[@name='Shutter Time [s]']">
                  <xsl:element name="mix:shutterSpeedValue">
                    <xsl:choose>
                      <xsl:when test="java:dk.kb.metadata.utils.StringUtils.splitableOnSlash(field[@name='Shutter Time [s]']/value)">
                      ...
                      <xsl:otherwise>
                        <xsl:element name="mix:numerator">
                          <xsl:value-of select="field[@name='Shutter Time [s]']/value" />
                        </xsl:element>
                        <xsl:element name="mix:denominator">
