...
<xsl:transform version="1.0"
  ...
  <xsl:variable name="CDL_LOCATION" select="'http://www.cdlib.org/inside/diglib/copyrightMD https://raw.githubusercontent.com/kb-dk/ginnungagap/dkCdlSRL/src/main/resources/scripts/xsd/copyright-md.xsd'" />
...
<!--    </xsl:for-each>-->
    ...
    <xsl:if test="field[@name='Crowd_Emneord']">
      <xsl:element name="mods:subject">
        ...
        <xsl:element name="mods:topic">
          <xsl:value-of select="field[@name='Crowd_Emneord']/value" />
        </xsl:element>
        <xsl:element name="mods:genre">
